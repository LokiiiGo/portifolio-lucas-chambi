const links = [
  ...
  /* Email */
  {
    ...
    label: "Email",
    href: "mailto:lucascalle880@gmail.com",
  },
  ...
  /* Whatsapp */
  {
    ...
    label: "Whatsapp",
    href: "https://api.whatsapp.com/send?phone=5511989994798"
  }
]
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4">
          {links.map((link) => (
            <a
              ...
              className="text-white inline-flex items-center justify-center gap-2 px-5 sm:px-6 py-3 sm:py-4 bg-zinc-950 border border-zinc-700 rounded-xl hover:border-white hover:bg-transparent transition-all duration-300 text-base sm:text-lg font-medium"
            >
              {link.icon}
              {link.label}
            </a>
